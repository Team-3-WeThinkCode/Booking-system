...
class test_event_booking(unittest.TestCase):
    ...
    def test_create_booking_body(self):
        ...
        new_body, id = booking.create_booking_body(test_event, "fake")
    ...
    def test_get_chosen_slot_True(self):
        status, chosen_slot1 = booking.get_chosen_slot(self.test_obj, "student", "lo7ami5f9pu7s4qdlun76h7m2k")
        self.assertEqual((status, chosen_slot1), (True, self.test_obj[0]))


    def test_get_chosen_slot_False(self):
        status, chosen_slot2 = booking.get_chosen_slot(self.test_obj, "jroy", "rq731nlq01brfe4egl6b9ifu14")
        self.assertEqual((status, chosen_slot2), (False, {}))
        

    def test_get_chosen_slot_True_with_attendee(self):
        status, chosen_slot3 = booking.get_chosen_slot(self.test_obj, "jroy", "d9h0im0u6scfdgk98o9kkf7o78")
        self.assertEqual((status, chosen_slot3), (True, self.test_obj[2]))
