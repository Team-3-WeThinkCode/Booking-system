...
# ''')
    ...
    def test_get_user_input(self):
        ...
        response = booking.get_user_input(test_events_listings.test_obj, 'student')
    ...
    def test_create_body(self):
        sys.stdout = StringIO()
        response, unique_id = booking.create_booking_body(test_events_listings.test_obj[0], 'freal')
        new_body = {
